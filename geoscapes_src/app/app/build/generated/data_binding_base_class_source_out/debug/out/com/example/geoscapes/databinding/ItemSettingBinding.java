...
public final class ItemSettingBinding implements ViewBinding {
  ...
  private ItemSettingBinding(@NonNull LinearLayout rootView, @NonNull Switch settingSwitch,
  ...
  public static ItemSettingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      Switch settingSwitch = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ItemSettingBinding((LinearLayout) rootView, settingSwitch, settingTitle);
    }
