...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView,
      @NonNull FragmentContainerView bannerFragmentContainer,
      @NonNull BottomNavigationView bottomNavigationView,
      @NonNull FragmentContainerView fragmentContainerView) {
    this.rootView = rootView;
    this.bannerFragmentContainer = bannerFragmentContainer;
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.banner_fragment_container;
      FragmentContainerView bannerFragmentContainer = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, bannerFragmentContainer,
